// Program for calculating areas and volumes of different shapes
use std::io;
 //invoking functions for each shape's formula
fn trapezium() {
...
fn main () {
    println!("\nHi! , welcome to THE calculator
              \nThe following shapes are the shapes only supported by THE calculator
              \n1. Trapezium
              \n2. Rhombus
              \n3. Parallelogram
              \n4. Cube
    ...
    cylinder();
        ...
        println!("\nCannot be done by THE calculator");
    }
