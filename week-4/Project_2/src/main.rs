...
fn main() {
    ...
    println!("\nCalculator for Annual Incentives");
    let mut experience_input = String::new();
    let mut age_input = String::new();
    
    println!("\nDoes the employee have experience (yes/no):");
    ...
    // Step 2: use decision making to determine the incentives
        ...
        if age >= 40 {
            println!("\nThe incentive of the employee is N1,560,000");
        } else if age >= 30 && age < 40 {
            println!("\nThe incentive of the employee is N1,480,000");
        } else if age < 28 {
            println!("\nThe incentive of the employee is N1,300,000");
        }
    } else if experience == "no"{
        println!("\nThe incentive of the employee is N100,000");
    }
}
